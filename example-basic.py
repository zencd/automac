...
with AutoMac() as mac:
    # mac = mac  # type: AutoMac # todo check if still needed
    ...
    text_files = 'ahk bash bat c cc cfg css cxx groovy gradle java js json h hpp hxx kt log m md nfo php properties ps1 py rb reg sh sublime-syntax todo toml treetop txt xml yaml yml csv srt vtt'.split()
